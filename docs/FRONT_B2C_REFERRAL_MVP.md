...
**Передача партнёрам (read-only):** ветка [`partner-handoff`](https://github.com/viss1913/PFP_FRONT_ver3/tree/partner-handoff) — см. [`README.md`](../README.md), [`B2C_PLAN_HANDOFF.md`](./B2C_PLAN_HANDOFF.md), skill [`.cursor/skills/b2c-plan-handoff/SKILL.md`](../.cursor/skills/b2c-plan-handoff/SKILL.md).

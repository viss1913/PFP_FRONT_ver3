...
import B2cStepAssets from '../b2c/B2cStepAssets';
...
const StepAssets: React.FC<StepAssetsProps> = ({ data, setData, onNext, onPrev, guestMode = false }) => {
    ...
    const commitValue = (numValue: number) => {
        setValue(numValue);
        ...
        <div>
            ...
            <div
                style={{
                    ...
                    boxShadow:
                        '0 16px 30px rgba(71, 85, 105, 0.12), inset 0 1px 0 rgba(255,255,255,0.85)',
                    maxWidth: '500px',
                    ...
                    <div style={{ position: 'relative' }}>
                        <input
                            ...
                            style={{
                                ...
                                textAlign: 'center',
                                boxShadow:
                                    'inset 0 1px 0 rgba(255,255,255,0.92), 0 10px 24px rgba(120, 140, 170, 0.14)',
                            }}
                        />
                        <span
                            style={{

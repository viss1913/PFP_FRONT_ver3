...
export const getGoalModalConfig = (params: {
    ...
    const targetRangeByGoal: Record<string, SliderRange> = {
        ...
        capital: { min: 2_000_000, max: 40_000_000, step: 200_000 },
        inheritance: { min: 2_000_000, max: 40_000_000, step: 200_000 },
    ...
    const termRangeByGoal: Record<string, SliderRange> = {
        ...
        capital: { min: 2, max: 20, step: 1 },
        inheritance: { min: 1, max: 20, step: 1 },
    ...
    const standardTargetByGoalId: Record<string, number> = {
        ...
        capital: Math.max(net * 36, 6_000_000),
        inheritance: Math.max(net * 36, 6_000_000),
